...
const Projects = () => {
    ...
    return <div className="mt-5 text-center ">
        ...
        <div className="lg:flex flex-wrap gap-10 items-center justify-center text-center  bg-gray-400 mb-24">
        {projects.map(ele=>{
            return(
                <div key={ele.Name} className="lg:w-1/4 md:w-1/2 p-4 w-full border-2 rounded-lg m-4">
