...
const Hero = () => {
    return<div className="z-10"><div className=" ">
         <Ripple
          numSquares={30}
        maxOpacity={0.3}
        duration={3}
...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 lg:py-0 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font lg:text-6xl text-4xl mb-4 font-extrabold text-black">Greetings!  <br className="hidden lg:inline-block"/>    I'm Ayman Sayed
    ...
    /></span>
      <p className="mb-8 leading-relaxed"> A data enthusiast and analytical mind at heart. With a passion for uncovering patterns and turning raw numbers into actionable insights,</p>
